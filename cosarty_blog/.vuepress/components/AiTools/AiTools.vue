<template>
  <div class="">
    <div v-for="(value, key) in aiConfig" :key="key" class="flex flex-col">
      <div
        class="text-3xl font-bold text-gray-500 py-[20px] mb-[20px] border-0 border-b-2 border-gray-400 border-solid"
      >
        {{ value.label }}
      </div>
